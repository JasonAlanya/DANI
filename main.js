            ...
            draw() {
              ...
              this._ctx.beginPath(),
                ...
                (this._ctx.strokeStyle = (0, e.hsla)(
                  this._hue,
                  this._flickering
                    ? (0, e.randomFloat)(0, this._brightness)
                    : this._brightness,
                  this._alpha
                )),
                this._ctx.stroke();
            ...
            play() {
              if (this.options.enabled && this._buffer.length) {
                var t = this._audioContext.createBufferSource(),
                  i =
                    this._buffer[(0, n.randomInt)(0, this._buffer.length - 1)],
                  s = this._audioContext.createGain();
                (t.buffer = i),
                  (s.gain.value = (0, n.randomFloat)(
    ...
    return (
      (() => {
        ...
        t.Fireworks = class {
          constructor(t) {
            ...
            (this._tick = 0),
              ...
              t instanceof HTMLCanvasElement
                ? ((this._container = t), (this._canvas = t))
                : ((this._container = t),
              ...
              (this.lineWidth = Object.assign(
                { explosion: { min: 1, max: 3 }, trace: { min: 1, max: 2 } },
                _
              )),
          ...
          setSize() {
            var {
              width: t = this._container instanceof HTMLCanvasElement
                ? this._canvas.width
                : this._container.clientWidth,
              height: i = this._container instanceof HTMLCanvasElement
                ? this._canvas.height
          ...
          render() {
            ...
            if (this._ctx && this._running) {
              ...
              (this._timestamp = t),
                (this._tick += (i * (this.intensity * Math.PI)) / 1e3);
            }
          }
          drawBoundaries() {
                ...
                (this._traces.push(
                  new i.Trace({
                    x:
                      (this._width *
                        (0, o.randomInt)(
                          this.rocketsPoint.min,
                          this.rocketsPoint.max
                        )) /
                      100,
                    y: this._height,
                    dx:
          ...
          drawTrace() {
            ...
            for (
              this._ctx.lineWidth = (0, o.randomFloat)(
